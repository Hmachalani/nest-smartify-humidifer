...
var getInfo = function(serialNumber, callback) {
    login(function() {
        get(function(data) {
            ...
            callback(null, merge(data.device[serialNumber], data.shared[serialNumber]));
        });
    });
};
        ...
        response.on('end', function() {
            ...
            if (allData && typeof allData === 'string') {
                try{
                    ...
                    console.log("Failed to parse Nest results. Data: "+allData);
                    callback(e, null);
                }
                
            }
            if (callback) {
                callback(null, allData, response.headers || {});
            }
        });
    });
